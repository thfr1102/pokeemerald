...
static bool8 AnimateTradeSequenceCable(void)
{
    ...
    case 63:
        ...
        BlendPalettes(1 << (16 + gSprites[sTradeData->unk_D3].oam.paletteNum), 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeData->state++;
        sTradeData->timer = 0;
        break;
    case 64:
        BeginNormalPaletteFade(1 << (16 + gSprites[sTradeData->unk_D3].oam.paletteNum), 1, 16, 0, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeData->state++;
        break;
    case 65:
...
static void sub_807E5D8(struct Sprite *sprite)
{
    ...
    if (++ sprite->data[0] == 44)
    {
        ...
        sprite->data[0] = 0;
        BeginNormalPaletteFade(1 << (16 + sprite->oam.paletteNum), -1, 0, 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
    }
}
...
static void _CreateInGameTradePokemon(u8 whichPlayerMon, u8 whichInGameTrade)
{
    ...
    CreateMon(pokemon, inGameTrade->species, level, (31 + 1), 1, inGameTrade->personality, 1, inGameTrade->otId);
