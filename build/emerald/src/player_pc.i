...
static void InitItemStorageMenu(u8 taskId, u8 var)
{
    ...
    data[4] = AddWindow(&windowTemplate);
    SetStandardWindowBorderStyle(data[4], 0);
    PrintMenuTable(data[4], (size_t)(sizeof(gPCText_ItemPCOptionsText) / sizeof((gPCText_ItemPCOptionsText)[0])), gPCText_ItemPCOptionsText);
...
{
    u8 r4 = sub_81D1C84(2);
    PrintMenuTable(r4, (size_t)(sizeof(gMailboxMailOptions) / sizeof((gMailboxMailOptions)[0])), gMailboxMailOptions);
