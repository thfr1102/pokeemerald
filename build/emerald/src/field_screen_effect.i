...
void AnimateFlash(u8 flashLevel)
{
    ...
    bool8 fullBrightness = 0;
    if (!flashLevel)
        fullBrightness = 1;
    StartUpdateFlashLevelEffect(240 / 2, 160 / 2, sFlashLevelPixelRadii[curFlashLevel], sFlashLevelPixelRadii[flashLevel], fullBrightness, 1);
...
static void Task_SpinEnterWarp(u8 taskId)
{
    ...
    case 0:
        ...
        break;
    case 1:
        if (WaitForWeatherFadeIn() && IsPlayerSpinEntranceActive() != 1)
        {
            UnfreezeObjectEvents();
            ScriptContext2_Disable();
            DestroyTask(taskId);
...
# 1129 "src/field_screen_effect.c"
...
# 1262 "src/field_screen_effect.c"
