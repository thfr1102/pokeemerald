...
# 32 "src/battle_factory_screen.c" 2
# 1 "include/constants/rgb.h" 1
# 33 "src/battle_factory_screen.c" 2
# 46 "src/battle_factory_screen.c"
enum {
...
struct FactorySelectScreen
{
    ...
    u8 yesNoCursorPos;
    u8 unused;
    struct FactorySelectableMon mons[6];
    struct FactoryMonPic monPics[3];
...
static __attribute__((section("ewram_data"))) u8 *sSelectMonPicBgTilesetBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) u8 *sSelectMenuTilemapBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) u8 *sSelectMonPicBgTilemapBuffer = ((void *)0);
...
static __attribute__((section("ewram_data"))) u8 *sSwapMonPicBgTilesetBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) u8 *sSwapMenuTilemapBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) u8 *sSwapMonPicBgTilemapBuffer = ((void *)0);
...
static const u16 sInterface_Pal[] = INCBIN_U16("graphics/battle_frontier/factory_screen/interface.gbapal");
static const u8 sPokeball_Gfx[] = INCBIN_U8( "graphics/battle_frontier/factory_screen/pokeball.4bpp");
...
static const u16 sSwapText_Pal[] = INCBIN_U16("graphics/battle_frontier/factory_screen/text.gbapal");
...
# 1127 "src/battle_factory_screen.c"
static void CB2_InitSelectScreen(void)
{
    u8 taskId;
    ...
    case 1:
        ...
        sSelectMonPicBgTilemapBuffer = AllocZeroed(0x800);
        ChangeBgX(0, 0, 0);
        ChangeBgY(0, 0, 0);
        ChangeBgX(1, 0, 0);
        ChangeBgY(1, 0, 0);
    ...
    case 2:
        ...
        CpuSet(sMonPicBg_Gfx, sSelectMonPicBgTilesetBuffer, 0x00000000 | ((0x60)/(16/8) & 0x1FFFFF));
    ...
    case 10:
        ...
        else
        {
            ...
            sFactorySelectScreen->fadeSpeciesNameActive = 0;
...
static void Select_UpdateMenuCursorPosition(s8 direction)
{
    if (direction > 0)
    {
        if (sFactorySelectScreen->menuCursorPos != (size_t)(sizeof(sSelect_MenuOptionFuncs) / sizeof((sSelect_MenuOptionFuncs)[0])) - 1)
    ...
    else
    {
        if (sFactorySelectScreen->menuCursorPos != 0)
            ...
            sFactorySelectScreen->menuCursorPos = (size_t)(sizeof(sSelect_MenuOptionFuncs) / sizeof((sSelect_MenuOptionFuncs)[0])) - 1;
    }
...
static void Select_Task_OpenSummaryScreen(u8 taskId)
{
    ...
    case 7:
        if (!gPaletteFade.active)
        {
            ...
            { Free(sSelectMonPicBgTilesetBuffer); sSelectMonPicBgTilesetBuffer = ((void *)0); };
            { Free(sSelectMenuTilemapBuffer); sSelectMenuTilemapBuffer = ((void *)0); };
            { Free(sSelectMonPicBgTilemapBuffer); sSelectMonPicBgTilemapBuffer = ((void *)0); };
    ...
    case 8:
        ...
        ShowPokemonSummaryScreen(PSS_MODE_LOCK_MOVES, sFactorySelectMons, currMonId, 6 - 1, CB2_InitSelectScreen);
        break;
    }
}
...
{
    if (sFactorySelectScreen->monPicAnimating == 1)
        return;
    ...
    case 5:
        if (({(gMain.newKeys) & (0x0001);}))
        {
            ...
            else
            {
                ...
                sFactorySelectScreen->fadeSpeciesNameActive = 1;
...
static void Select_Task_HandleMenu(u8 taskId)
{
    ...
    case 2:
        if (!sFactorySelectScreen->fromSummaryScreen)
            OpenMonPic(&sFactorySelectScreen->monPics[1].bgSpriteId, &sFactorySelectScreen->monPicAnimating, 0);
    ...
    case 3:
        ...
        {
            PlaySE(5);
            CloseMonPic(sFactorySelectScreen->monPics[1], &sFactorySelectScreen->monPicAnimating, 0);
...
# 1725 "src/battle_factory_screen.c"
static void CreateFrontierFactorySelectableMons(u8 firstMonId)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, 32, &friendship);
...
static void Select_PrintRentalPkmnString(void)
{
    FillWindowPixelBuffer(SELECT_WIN_TITLE, ((0) | ((0) << 4)));
    AddTextPrinterParameterized(SELECT_WIN_TITLE, 1, gText_RentalPkmn2, 2, 1, 0, ((void *)0));
...
static void Select_PrintMonSpecies(void)
{
    ...
    FillWindowPixelBuffer(SELECT_WIN_SPECIES, ((0) | ((0) << 4)));
...
static void Select_PrintSelectMonString(void)
{
    ...
    FillWindowPixelBuffer(SELECT_WIN_INFO, ((0) | ((0) << 4)));
    ...
    AddTextPrinterParameterized(SELECT_WIN_INFO, 1, str, 2, 5, 0, ((void *)0));
...
{
    FillWindowPixelBuffer(SELECT_WIN_INFO, ((0) | ((0) << 4)));
    AddTextPrinterParameterized(SELECT_WIN_INFO, 1, gText_CantSelectSamePkmn, 2, 5, 0, ((void *)0));
    CopyWindowToVram(SELECT_WIN_INFO, 2);
}
...
static void Select_PrintMenuOptions(void)
{
    ...
    FillWindowPixelBuffer(SELECT_WIN_OPTIONS, ((0) | ((0) << 4)));
...
static void Select_PrintYesNoOptions(void)
{
    ...
    FillWindowPixelBuffer(SELECT_WIN_YES_NO, ((0) | ((0) << 4)));
...
static void Select_PrintMonCategory(void)
{
    ...
    {
        PutWindowTilemap(SELECT_WIN_MON_CATEGORY);
        FillWindowPixelBuffer(SELECT_WIN_MON_CATEGORY, ((0) | ((0) << 4)));
        species = GetMonData(&sFactorySelectScreen->mons[monId].monData, 11, ((void *)0));
        CopyMonCategoryText(SpeciesToNationalPokedexNum(species), text);
        x = GetStringRightAlignXOffset(1, text, 0x76);
        AddTextPrinterParameterized(SELECT_WIN_MON_CATEGORY, 1, text, x, 1, 0, ((void *)0));
...
static void Select_CreateMonSprite(void)
{
    ...
    sFactorySelectScreen->monPics[1].monSpriteId = CreateMonPicSprite_HandleDeoxys(species, otId, personality, 1, 88, 32, 15, 0xFFFF);
    ...
    sFactorySelectScreen->monPicAnimating = 0;
}
...
static void Select_ReshowMonSprite(void)
{
    ...
    gSprites[sFactorySelectScreen->monPics[1].bgSpriteId].invisible = 1;
}
    ...
    for (i = 0; i < 3; i++)
    {
        for (j = 0; j < 6; j++)
        {
            if (sFactorySelectScreen->mons[j].selectedId == i + 1)
            {
                ...
                sFactorySelectScreen->monPics[i].monSpriteId = CreateMonPicSprite_HandleDeoxys(species, otId, personality, 1, (i * 72) + 16, 32, i + 13, 0xFFFF);
...
static void SpriteCB_OpenChosenMonPics(struct Sprite *sprite)
{
    ...
    {
        sprite->invisible = 1;
        gSprites[sFactorySelectScreen->monPics[0].bgSpriteId].invisible = 1;
        gSprites[sFactorySelectScreen->monPics[2].bgSpriteId].invisible = 1;
...
# 2120 "src/battle_factory_screen.c"
...
static void Select_Task_CloseChosenMonPics(u8 taskId)
{
    ...
    default:
        HideBg(3);
        gSprites[sFactorySelectScreen->monPics[1].bgSpriteId].invisible = 0;
        gSprites[sFactorySelectScreen->monPics[1].bgSpriteId].callback = SpriteCB_CloseChosenMonPics;
        gSprites[sFactorySelectScreen->monPics[0].bgSpriteId].invisible = 0;
        gSprites[sFactorySelectScreen->monPics[0].bgSpriteId].callback = SpriteCallbackDummy;
        gSprites[sFactorySelectScreen->monPics[2].bgSpriteId].invisible = 0;
...
static void Select_ShowChosenMons(void)
{
    ...
    sFactorySelectScreen->monPicAnimating = 1;
}
...
static void Select_Task_FadeSpeciesName(u8 taskId)
{
    ...
    case FADESTATE_INIT:
        ...
        sFactorySelectScreen->fadeSpeciesNameFadeOut = 1;
    ...
    case FADESTATE_RUN:
        if (sFactorySelectScreen->fadeSpeciesNameActive)
        {
            ...
            else
            {
                ...
                {
                    sFactorySelectScreen->fadeSpeciesNameFadeOut = 0;
                }
...
static void CopySwappedMonData(void)
{
    ...
    friendship = 0;
    SetMonData(&gPlayerParty[sFactorySwapScreen->playerMonId], 32, &friendship);
...
# 2367 "src/battle_factory_screen.c"
static void Swap_Task_OpenSummaryScreen(u8 taskId)
{
    ...
    case 7:
        if (!gPaletteFade.active)
        {
            ...
            { Free(sSwapMonPicBgTilesetBuffer); sSwapMonPicBgTilesetBuffer = ((void *)0); };
            { Free(sSwapMenuTilemapBuffer); sSwapMenuTilemapBuffer = ((void *)0); };
            { Free(sSwapMonPicBgTilemapBuffer); sSwapMonPicBgTilemapBuffer = ((void *)0); };
            FreeAllWindowBuffers();
            gTasks[taskId].data[0] = 8;
        }
        break;
    case 8:
        ...
        ShowPokemonSummaryScreen(PSS_MODE_NORMAL, gPlayerParty, sFactorySwapScreen->cursorPos, 3 - 1, CB2_InitSwapScreen);
        break;
    }
}
...
{
    if (sFactorySwapScreen->monPicAnimating == 1)
        return;
...
static void Swap_HandleQuitSwappingResposne(u8 taskId)
{
    ...
    {
        gTasks[taskId].data[0] = 0;
        gTasks[taskId].data[6] = (u32)(Swap_Task_HandleChooseMons) >> 16;
        gTasks[taskId].data[7] = (u32)(Swap_Task_HandleChooseMons);
...
static void Swap_AskQuitSwapping(u8 taskId)
{
    if (gTasks[taskId].data[0] == 0)
    {
        ...
        gTasks[taskId].data[0] = 4;
        gTasks[taskId].data[6] = (u32)(Swap_HandleQuitSwappingResposne) >> 16;
        gTasks[taskId].data[7] = (u32)(Swap_HandleQuitSwappingResposne);
...
{
    CloseMonPic(sFactorySwapScreen->monPic, &sFactorySwapScreen->monPicAnimating, 1);
    if (gTasks[taskId].data[1] == 1)
    {
        gTasks[taskId].data[0] = 0;
        gTasks[taskId].func = Swap_Task_Exit;
...
static void Swap_AskAcceptMon(u8 taskId)
{
    if (gTasks[taskId].data[0] == 0)
    {
        OpenMonPic(&sFactorySwapScreen->monPic.bgSpriteId, &sFactorySwapScreen->monPicAnimating, 1);
        Swap_PrintOnInfoWindow(gText_AcceptThisPkmn);
        sFactorySwapScreen->monSwapped = 1;
        gTasks[taskId].data[0] = 4;
        gTasks[taskId].data[6] = (u32)(Swap_HandleAcceptMonResponse) >> 16;
        gTasks[taskId].data[7] = (u32)(Swap_HandleAcceptMonResponse);
        gTasks[taskId].func = Swap_Task_HandleYesNo;
    }
}
...
static void Swap_Task_HandleChooseMons(u8 taskId)
{
    ...
    case 0:
        if (!gPaletteFade.active)
        {
            sFactorySwapScreen->fadeSpeciesNameActive = 1;
            gTasks[taskId].data[0] = 1;
        }
        break;
    case 1:
        if (({(gMain.newKeys) & (0x0001);}))
        {
            ...
            PlaySE(5);
            sFactorySwapScreen->fadeSpeciesNameActive = 0;
        ...
        else if (({(gMain.newKeys) & (0x0002);}))
        {
            ...
            Swap_PrintMonSpeciesAtFade();
            Swap_EraseSpeciesWindow();
            gTasks[taskId].data[6] = (u32)(Swap_AskQuitSwapping) >> 16;
            gTasks[taskId].data[7] = (u32)(Swap_AskQuitSwapping);
            gTasks[taskId].data[0] = 0;
...
static void Swap_Task_FadeSpeciesName(u8 taskId)
{
    ...
    case FADESTATE_INIT:
        ...
        sFactorySwapScreen->fadeSpeciesNameFadeOut = 1;
        gTasks[taskId].data[0] = FADESTATE_RUN;
        break;
    case FADESTATE_RUN:
        if (sFactorySwapScreen->fadeSpeciesNameActive)
        {
            ...
            else
            {
                ...
                {
                    sFactorySwapScreen->fadeSpeciesNameFadeOut = 0;
                }
...
static void Swap_Task_SlideCycleBalls(u8 taskId)
{
    ...
    {
    case 0:
        gTasks[taskId].data[(0) + 1] = 0;
        gTasks[taskId].data[(1) + 1] = 0;
        gTasks[taskId].data[(2) + 1] = 0;
        gTasks[taskId].data[0] = 1;
        break;
    case 1:
        lastX = 0;
        for (i = 3 - 1; i >= 0; i--)
        {
            if (i != 3 - 1)
            {
                ...
                if (posX == 16 || gTasks[taskId].data[(i + 1) + 1] == 1)
                {
...
# 2869 "src/battle_factory_screen.c"
static void Swap_Task_SlideButtonOnOffScreen(u8 taskId)
{
    u8 i, j;
    s32 posX = 0;
    s8 deltaX = gTasks[taskId].data[3];
    bool8 sliding;
    s16 currPosX;
    u8 prevTaskId;
    ...
    case 0:
        ...
        if (sliding == 1)
        {
            ...
            for (i = 0; i < (size_t)(sizeof(sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0]) / sizeof((sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0])[0])); i++)
            {
                for (j = 0; j < (size_t)(sizeof(sFactorySwapScreen->pkmnForSwapButtonSpriteIds) / sizeof((sFactorySwapScreen->pkmnForSwapButtonSpriteIds)[0])); j++)
        ...
        else
        {
            ...
            prevTaskId = gTasks[taskId].data[1];
            gTasks[prevTaskId].data[3] = 1;
            DestroyTask(taskId);
        }
        break;
    case 1:
        ...
        if (sliding == 1)
        {
            ...
            for (i = 0; i < (size_t)(sizeof(sFactorySwapScreen->cancelButtonSpriteIds) / sizeof((sFactorySwapScreen->cancelButtonSpriteIds)[0])); i++)
            {
                for (j = 0; j < (size_t)(sizeof(sFactorySwapScreen->cancelButtonSpriteIds[0]) / sizeof((sFactorySwapScreen->cancelButtonSpriteIds[0])[0])); j++)
        ...
        else
        {
            ...
            for (j = 0; j < (size_t)(sizeof(sFactorySwapScreen->cancelButtonSpriteIds) / sizeof((sFactorySwapScreen->cancelButtonSpriteIds)[0])); j++)
            {
...
static void Swap_Task_ScreenInfoTransitionOut(u8 taskId)
{
    ...
    case 3:
        if (!gPaletteFade.active)
        {
            FillWindowPixelBuffer(SWAP_WIN_ACTION_FADE, ((0) | ((0) << 4)));
            ...
            if (sFactorySwapScreen->inEnemyScreen == 1)
            {
                ...
                gTasks[slideTaskId].data[1] = taskId;
                gTasks[slideTaskId].data[0] = 0;
                gTasks[slideTaskId].data[2] = 0;
...
# 3185 "src/battle_factory_screen.c"
    ...
    case 3:
         ...
         && gTasks[sFactorySwapScreen->fadeSpeciesNameTaskId].data[4] == 1)
        {
            ...
            else
            {
                ...
                for (i = 0; i < (size_t)(sizeof(sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0]) / sizeof((sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0])[0])); i++)
                    gSprites[sFactorySwapScreen->pkmnForSwapButtonSpriteIds[1][i]].invisible = 1;
            }
...
static void Swap_InitStruct(void)
{
    if (sFactorySwapScreen == ((void *)0))
    {
        ...
        sFactorySwapScreen->monPicAnimating = 0;
...
static void CB2_InitSwapScreen(void)
{
    ...
    case 1:
        ...
        sSwapMonPicBgTilemapBuffer = AllocZeroed(0x800);
        ChangeBgX(0, 0, 0);
        ChangeBgY(0, 0, 0);
        ChangeBgX(1, 0, 0);
        ChangeBgY(1, 0, 0);
    ...
    case 2:
        ...
        CpuSet(sMonPicBg_Gfx, sSwapMonPicBgTilesetBuffer, 0x00000000 | ((0x60)/(16/8) & 0x1FFFFF));
...
static void Swap_InitAllSprites(void)
{
    ...
    sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0][0] = CreateSprite(&spriteTemplate, 240, 120, 10);

    spriteTemplate = sSpriteTemplate_Swap_MenuHighlightLeft;
    spriteTemplate.tileTag = GFXTAG_ACTION_BOX_RIGHT;
    sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0][1] = CreateSprite(&spriteTemplate, 240 + 16, 120, 10);
    sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0][2] = CreateSprite(&spriteTemplate, 240 + 48, 120, 10);

    spriteTemplate = sSpriteTemplate_Swap_Arrow;
    spriteTemplate.tileTag = GFXTAG_ACTION_HIGHLIGHT_LEFT;
    sFactorySwapScreen->pkmnForSwapButtonSpriteIds[1][0] = CreateSprite(&spriteTemplate, 240, 120, 1);

    spriteTemplate = sSpriteTemplate_Swap_MenuHighlightLeft;
    spriteTemplate.tileTag = GFXTAG_ACTION_HIGHLIGHT_MIDDLE;
    sFactorySwapScreen->pkmnForSwapButtonSpriteIds[1][1] = CreateSprite(&spriteTemplate, 240 + 16, 120, 1);
    spriteTemplate.tileTag = GFXTAG_ACTION_HIGHLIGHT_RIGHT;
    sFactorySwapScreen->pkmnForSwapButtonSpriteIds[1][2] = CreateSprite(&spriteTemplate, 240 + 48, 120, 1);
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        gSprites[sFactorySwapScreen->pkmnForSwapButtonSpriteIds[i][0]].invisible = 1;
        gSprites[sFactorySwapScreen->pkmnForSwapButtonSpriteIds[i][1]].invisible = 1;
        gSprites[sFactorySwapScreen->pkmnForSwapButtonSpriteIds[i][2]].invisible = 1;
        gSprites[sFactorySwapScreen->cancelButtonSpriteIds[i][0]].invisible = 1;
        gSprites[sFactorySwapScreen->cancelButtonSpriteIds[i][1]].invisible = 1;
    }

    gSprites[sFactorySwapScreen->cancelButtonSpriteIds[0][0]].invisible = 0;
    gSprites[sFactorySwapScreen->cancelButtonSpriteIds[0][1]].invisible = 0;
    gSprites[sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0][0]].invisible = 0;
    gSprites[sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0][1]].invisible = 0;
    gSprites[sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0][2]].invisible = 0;
}
...
static void Swap_DestroyAllSprites(void)
{
    ...
    for (i = 0; i < (size_t)(sizeof(sFactorySwapScreen->pkmnForSwapButtonSpriteIds) / sizeof((sFactorySwapScreen->pkmnForSwapButtonSpriteIds)[0])); i++)
    {
        for (j = 0; j < (size_t)(sizeof(sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0]) / sizeof((sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0])[0])); j++)
...
static void Swap_UpdateMenuCursorPosition(s8 direction)
{
    ...
    if (direction > 0)
    {
        if (sFactorySwapScreen->menuCursorPos != (size_t)(sizeof(sSwap_MenuOptionFuncs) / sizeof((sSwap_MenuOptionFuncs)[0])) - 1)
    ...
    else
    {
        if (sFactorySwapScreen->menuCursorPos != 0)
            ...
            sFactorySwapScreen->menuCursorPos = (size_t)(sizeof(sSwap_MenuOptionFuncs) / sizeof((sSwap_MenuOptionFuncs)[0])) - 1;
    }
...
static void Swap_HighlightActionButton(u8 actionId)
{
    ...
    for (i = 0; i < (size_t)(sizeof(sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0]) / sizeof((sFactorySwapScreen->pkmnForSwapButtonSpriteIds[0])[0])); i++)
    {
        if (actionId == 2)
        {
            ...
            gSprites[sFactorySwapScreen->pkmnForSwapButtonSpriteIds[1][i]].invisible = 0;


            if (i < (size_t)(sizeof(sFactorySwapScreen->cancelButtonSpriteIds[0]) / sizeof((sFactorySwapScreen->cancelButtonSpriteIds[0])[0])))
                gSprites[sFactorySwapScreen->cancelButtonSpriteIds[1][i]].invisible = 1;
        }
        else if (actionId == 3)
        {

            if (i < (size_t)(sizeof(sFactorySwapScreen->cancelButtonSpriteIds[0]) / sizeof((sFactorySwapScreen->cancelButtonSpriteIds[0])[0])))
                gSprites[sFactorySwapScreen->cancelButtonSpriteIds[1][i]].invisible = 0;
...
{
    PutWindowTilemap(SWAP_WIN_SPECIES);
    FillWindowPixelBuffer(SWAP_WIN_SPECIES, ((0) | ((0) << 4)));
...
static void Swap_EraseSpeciesAtFadeWindow(void)
{
    ...
    FillWindowPixelBuffer(SWAP_WIN_SPECIES_AT_FADE, ((0) | ((0) << 4)));
...
static void Swap_PrintPkmnSwap(void)
{
    FillWindowPixelBuffer(SWAP_WIN_TITLE, ((1) | ((1) << 4)));
    AddTextPrinterParameterized(SWAP_WIN_TITLE, 1, gText_PkmnSwap, 2, 1, 0, ((void *)0));
...
{
    FillWindowPixelBuffer(SWAP_WIN_INFO, ((0) | ((0) << 4)));
    AddTextPrinterParameterized(SWAP_WIN_INFO, 1, str, 2, 5, 0, ((void *)0));
...
{
    PutWindowTilemap(SWAP_WIN_OPTIONS);
    FillWindowPixelBuffer(SWAP_WIN_OPTIONS, ((0) | ((0) << 4)));
...
static void Swap_PrintYesNoOptions(void)
{
    ...
    FillWindowPixelBuffer(SWAP_WIN_YES_NO, ((0) | ((0) << 4)));
...
static void Swap_PrintMonSpeciesAtFade(void)
{
    ...
    CpuSet(sSwapText_Pal, pal, 0x00000000 | ((8)/(16/8) & 0x1FFFFF));
    if (!sFactorySwapScreen->fromSummaryScreen)
...
static void Swap_PrintMonCategory(void)
{
    ...
    FillWindowPixelBuffer(SWAP_WIN_MON_CATEGORY, ((0) | ((0) << 4)));
    if (monId >= 3)
    {
    ...
    else
    {
        ...
        CopyMonCategoryText(SpeciesToNationalPokedexNum(species), text);
        x = GetStringRightAlignXOffset(1, text, 0x76);
        AddTextPrinterParameterized(SWAP_WIN_MON_CATEGORY, 1, text, x, 1, 0, ((void *)0));
        CopyWindowToVram(SWAP_WIN_MON_CATEGORY, 2);
    }
}
...
{
    gTasks[taskId].data[6] = (u32)(Swap_Task_SwitchPartyScreen) >> 16;
    gTasks[taskId].data[7] = (u32)(Swap_Task_SwitchPartyScreen);
    gTasks[taskId].data[5] = 0;
    gTasks[taskId].data[0] = 0;
    gTasks[taskId].func = Swap_Task_ScreenInfoTransitionOut;
}
...
static void Swap_ActionMon(u8 taskId)
{
    if (!sFactorySwapScreen->inEnemyScreen)
    {
        gTasks[taskId].data[6] = (u32)(Swap_Task_HandleMenu) >> 16;
        gTasks[taskId].data[7] = (u32)(Swap_Task_HandleMenu);
    ...
    {
        gTasks[taskId].data[6] = (u32)(Swap_AskAcceptMon) >> 16;
        gTasks[taskId].data[7] = (u32)(Swap_AskAcceptMon);
        gTasks[taskId].data[5] = 0;
    }
    gTasks[taskId].data[0] = 0;
    gTasks[taskId].func = Swap_Task_ScreenInfoTransitionOut;
...
static void OpenMonPic(u8 *spriteId, bool8 *animating, bool8 swapScreen)
{
    *spriteId = CreateSprite(&sSpriteTemplate_Swap_MonPicBgAnim, 120, 64, 1);
    ...
    gSprites[*spriteId].data[7] = swapScreen;
    *animating = 1;
}
...
static void Swap_ShowSummaryMonSprite(void)
{
    ...
    sFactorySwapScreen->monPic.monSpriteId = CreateMonPicSprite_HandleDeoxys(species, personality, otId, 1, 88, 32, 15, 0xFFFF);
    ...
    gSprites[sFactorySwapScreen->monPic.bgSpriteId].invisible = 1;
}
...
static void CloseMonPic(struct FactoryMonPic pic, bool8 *animating, bool8 swapScreen)
{
    ...
    gTasks[taskId].data[6] = pic.bgSpriteId;
    gTasks[taskId].func(taskId);
    *animating = 1;
}
...
static void Task_CloseMonPic(u8 taskId)
{
    ...
    default:
        ...
        gSprites[task->data[6]].callback = SpriteCB_CloseMonPic;
...
static void Swap_CreateMonSprite(void)
{
    ...
    sFactorySwapScreen->monPic.monSpriteId = CreateMonPicSprite_HandleDeoxys(species, otId, personality, 1, 88, 32, 15, 0xFFFF);
    gSprites[sFactorySwapScreen->monPic.monSpriteId].centerToCornerVecX = 0;
    gSprites[sFactorySwapScreen->monPic.monSpriteId].centerToCornerVecY = 0;
