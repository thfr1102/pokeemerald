...
# 2995 "src/battle_anim_effects_1.c"
void AnimMovePowderParticle(struct Sprite* sprite)
{
    sprite->pos1.x += gBattleAnimArgs[0];
    sprite->pos1.y += gBattleAnimArgs[1];
...
# 3239 "src/battle_anim_effects_1.c"
static void AnimMoveSmallCloud(struct Sprite* sprite)
{
    InitSpritePosToAnimTarget(sprite, 1);
    sprite->data[0] = gBattleAnimArgs[3];
...
# 3275 "src/battle_anim_effects_1.c"
static void AnimPluck(struct Sprite* sprite)
{
    InitSpritePosToAnimTarget(sprite, 1);
...
# 3502 "src/battle_anim_effects_1.c"
...
# 3544 "src/battle_anim_effects_1.c"
void AnimSporeParticle(struct Sprite* sprite)
{
    InitSpritePosToAnimTarget(sprite, 1);
...
# 3742 "src/battle_anim_effects_1.c"
void AnimTranslateLinearSingleSineWave(struct Sprite* sprite)
{
    InitSpritePosToAnimAttacker(sprite, 1);
    if (GetBattlerSide(gBattleAnimAttacker) != 0)
...
# 4032 "src/battle_anim_effects_1.c"
