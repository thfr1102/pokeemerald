...
static void Task_NewGameBirchSpeech_FadePlayerToWhite(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        SetGpuReg(0x0, 0x1000 | 0x0040);
        BeginNormalPaletteFade(0xFFFF0000, 0, 0, 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
...
static void NewGameBirchSpeech_ShowGenderMenu(void)
{
    ...
    PrintMenuTable(1, (size_t)(sizeof(sMenuActions_Gender) / sizeof((sMenuActions_Gender)[0])), sMenuActions_Gender);
