...
static void PlayerHandleSuccessBallThrowAnim(void)
{
    ...
    if (IsCriticalCapture())
        InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler, gBattlerTarget, 7);
    else
        InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler, gBattlerTarget, 3);
